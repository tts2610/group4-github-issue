              ...
              return (
                <div class="timeline-item">
                  ...
                  <div class="timeline-content timeline-card js--fadeInLeft">
                    <div class="timeline-img-header" style={{    background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.4)), url(`${x.user.avatar_url}`) center center no-repeat;
}}>
                      <h2>{x.user.login}</h2>
                    </div>
                    <div class="date"><Moment fromNow>{x.created_at}</Moment></div>
                    <p>
                     {x.body}
                    </p>
                  </div>
